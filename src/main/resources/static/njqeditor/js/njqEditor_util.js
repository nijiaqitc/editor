    ...
    function loadUtil(njqEditor){
    	var ignoreNode = njqEditor.sysConfig.ignoreNode;
    	var labels = njqEditor.sysConfig.mergeLabel;
    	var parentIncludeNode = njqEditor.sysConfig.parentIncludeNode;
    	var childIncludeNode = njqEditor.sysConfig.childIncludeNode;
    	var spaceNode = njqEditor.sysConfig.spaceNode;
    	var singleNode = njqEditor.sysConfig.singleNode;
    	var session;
    	/**
    	 * 通用工具区，类似于util工具类
    	 */
