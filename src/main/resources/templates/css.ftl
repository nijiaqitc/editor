...
<body>
	...
	<div style="float:right;width:78%;height:100%;">
		<div class="panel panel-default" style="margin-bottom: 0px;">
		  <div class="panel-body" >
		    ...
		    <hr style="margin-top: 8px;margin-bottom: 8px;">
		    <textarea style="width:100%;height:92%;border: 0;outline:none;" id="text1">.headbg{margin:0 8px /*display:none*/ } a:link,a:focus{   color:#00c } a:active{   color:red }</textarea>
		  </div>
		</div>
	</div>
	...
	<script type="text/javascript">
    	...
    	function decode1(){
    		$("#text1").val(vkbeautify.css($("#text1").val(),Number($("#spnum").val())));
    		
    	}
    	function mincode(){
    		$("#text1").val(vkbeautify.cssmin($("#text1").val()));
    	}
