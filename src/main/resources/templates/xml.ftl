...
<body>
	...
	<div style="float:right;width:78%;height:100%;">
		<div class="panel panel-default" style="margin-bottom: 0px;">
		  <div class="panel-body" >
		    ...
		    <hr style="margin-top: 8px;margin-bottom: 8px;">
		    <textarea style="width:100%;height:92%;border: 0;outline:none;" id="text1"><?xml version="1.0" encoding="UTF-8" ?><!DOCTYPE foo SYSTEM "Foo.dtd"><a><b>bbb</b><c/><d><soapenv:Envelope xmlns:soapenv="http://xxx" xmlns:xsd="http://yyy" xmlns:xsi="http://zzz"></soapenv></d><e><![CDATA[ <z></z> ]]></e><f><g></g></f></a></textarea>
		  </div>
		</div>
	</div>
	...
	<script type="text/javascript">
    	...
    	function decode1(){
    		$("#text1").val(vkbeautify.xml($("#text1").val(),Number($("#spnum").val())));
    		
    	}
    	function mincode(){
    		$("#text1").val(vkbeautify.xmlmin($("#text1").val()));
    	}
